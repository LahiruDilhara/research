...
Located in \texttt{designer/}\slash{}\texttt{analyzer/}, scripts \texttt{main.py}, \texttt{analyzer\_app.py}, and \texttt{homography\_engine.py} form a simulated touch verification suite.
