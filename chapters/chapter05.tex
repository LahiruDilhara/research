...
In paper virtual keyboard systems, a user's hands move across the printed paper while typing. If fiducial markers are placed in the center of the sheet, typing hands frequently block them, disrupting homography matrix $H$ calculations.

This challenge was solved through two design decisions:
\begin{enumerate}
