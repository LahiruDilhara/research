...
PARAM_COLS_PER_ARCH = {
    ...
    "LSTM_All_Combined":        ["hidden", "layers", "dropout", "lr", "batch_size"],
    "LSTM_Tip_Vel_Ratios":      ["hidden", "layers", "dropout", "lr", "batch_size"],
    "LSTM_Finger_Only":         ["hidden", "layers", "dropout", "lr", "batch_size"],
    "LSTM_Finger_Wrist":        ["hidden", "layers", "dropout", "lr", "batch_size"],
    "CNN1D":                    ["conv_ch", "fc_hid", "dropout", "lr", "batch_size"],
    "CNN1D_All_Combined":       ["conv_ch", "fc_hid", "dropout", "lr", "batch_size"],
    "CNN1D_Tip_Vel_Ratios":     ["conv_ch", "fc_hid", "dropout", "lr", "batch_size"],
    "CNN1D_Finger_Only":        ["conv_ch", "fc_hid", "dropout", "lr", "batch_size"],
    "CNN1D_Finger_Wrist":       ["conv_ch", "fc_hid", "dropout", "lr", "batch_size"],
    "ResNet1D":                 ["hidden_dim", "dropout", "lr", "batch_size"],
    "ResNet1D_All_Combined":    ["hidden_dim", "dropout", "lr", "batch_size"],
    "ResNet1D_Tip_Vel_Ratios":  ["hidden_dim", "dropout", "lr", "batch_size"],
    "ResNet1D_Finger_Only":     ["hidden_dim", "dropout", "lr", "batch_size"],
    "ResNet1D_Finger_Wrist":    ["hidden_dim", "dropout", "lr", "batch_size"],
    "Attention":                ["embed_dim", "num_heads", "dropout", "lr", "batch_size"],
    "Attention_All_Combined":   ["embed_dim", "num_heads", "dropout", "lr", "batch_size"],
    "Attention_Tip_Vel_Ratios": ["embed_dim", "num_heads", "dropout", "lr", "batch_size"],
    "Attention_Finger_Only":    ["embed_dim", "num_heads", "dropout", "lr", "batch_size"],
    "Attention_Finger_Wrist":   ["embed_dim", "num_heads", "dropout", "lr", "batch_size"],
    "BiLSTM":                   ["hidden", "layers", "dropout", "lr", "batch_size"],
    "BiLSTM_All_Combined":      ["hidden", "layers", "dropout", "lr", "batch_size"],
    "BiLSTM_Tip_Vel_Ratios":    ["hidden", "layers", "dropout", "lr", "batch_size"],
    "BiLSTM_Finger_Only":       ["hidden", "layers", "dropout", "lr", "batch_size"],
    "BiLSTM_Finger_Wrist":      ["hidden", "layers", "dropout", "lr", "batch_size"],
    "TCN":                      ["tcn_channels", "num_levels", "dropout", "lr", "batch_size"],
    "TCN_All_Combined":         ["tcn_channels", "num_levels", "dropout", "lr", "batch_size"],
    "TCN_Tip_Vel_Ratios":       ["tcn_channels", "num_levels", "dropout", "lr", "batch_size"],
    "TCN_Finger_Only":          ["tcn_channels", "num_levels", "dropout", "lr", "batch_size"],
    "TCN_Finger_Wrist":         ["tcn_channels", "num_levels", "dropout", "lr", "batch_size"],
}
