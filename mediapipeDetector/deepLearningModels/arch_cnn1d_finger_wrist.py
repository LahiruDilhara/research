"""
arch_cnn1d_finger_wrist.py
==========================
Architecture variant: CNN1D_Finger_Wrist
...
ARCH_NAME = "CNN1D_Finger_Wrist"
VARIANT   = "finger_wrist"
CONFIGS   = [{'id': 1, 'conv_ch': 32, 'fc_hid': 32, 'dropout': 0.2, 'lr': 0.0015, 'bs': 32}]
