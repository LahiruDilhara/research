...
def style_thesis_docx(docx_path):
    ...
    # 3. Format Cover Page & Cleanup Duplicate / Misplaced TOC Headings
    ...
    for p in list(doc.paragraphs):
        ...
        # Remove any stray "Table of Contents" or "Contents" title generated by Pandoc before our custom TOC block
        ...
        if cover_page_mode:
            ...
            if 'Customizable Paper-Based Virtual Keyboard System' in t:
                ...
                for r in p.runs:
                    ...
                    r.font.bold = True
                    r.font.color.rgb = RGBColor(0x0F, 0x29, 0x42)
                if 'National School of Business Management' in t:
                    p.paragraph_format.space_after = Pt(24)
                    r_pb = p.add_run()
